...
WhitneyGroup:
	...
	db 20, JIGGLYPUFF, GOLD_BERRY,       SING, ATTRACT, ICE_PUNCH, DOUBLESLAP
	db 20, TEDDIURSA,  PINK_BOW,       HEADBUTT, METAL_CLAW, LICK, MUD_SLAP
...
MortyGroup:
	...
	db 23, STANTLER,    NO_ITEM,       STOMP, HYPNOSIS, NIGHTMARE, LEER
	db 24, MISDREAVUS,  NO_ITEM,       SHADOW_BALL, PAIN_SPLIT, PERISH_SONG, DOUBLE_TEAM
